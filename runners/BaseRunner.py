...
class BaseRunner(ABC):
    ...
    def validation_epoch(self, val_loader, epoch):
        ...
        pbar = tqdm(val_loader, total=len(val_loader), smoothing=0.00, disable=not self.is_main_process)
        step = 0
        loss_sum = 0.
        dloss_sum = 0.
    ...
    def train(self):
        ...
        try:
            ...
            for epoch in range(start_epoch, self.config.training.n_epochs):
                ...
                pbar = tqdm(train_loader, total=len(train_loader), smoothing=0.00, disable=not self.is_main_process)
